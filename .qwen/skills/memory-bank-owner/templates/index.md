...
## Core
- [Principles](.memory-bank/mbb/principles.md) — SSoT-правила, именование, структура
- [System Environment](.memory-bank/system-env.md) — кеш окружения (TTL 1 час)
...
## Skills
- memory-bank-owner → `.qwen/skills/memory-bank-owner/SKILL.md`
- branch-manager    → `.qwen/skills/branch-manager/SKILL.md`
- commit-manager    → `.qwen/skills/commit-manager/SKILL.md`
- system-env        → `.qwen/skills/system-env/SKILL.md`

## Engineering Standards
- [Quality Gate](.memory-bank/spec/engineering/quality-gate.md)
- [Code Comments](.memory-bank/spec/engineering/code-comments.md)
...
- [ADR Index](.memory-bank/adr/index.md)
